...
as it efficiently tackles with the inherent complexity of the models we use, thus allowing an efficient execution of the formal tools defined in this paper, and is convenient to enumerate large sets of possible answers.
