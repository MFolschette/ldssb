...
It is essential to get an efficient method to enumerate all the admissible parametrizations.
we focus on Answer Set Programming (ASP) \cite{Baral03} to address this issue.
