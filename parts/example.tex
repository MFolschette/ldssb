...
Applied to the example in \pref{fig:runningPH} where cooperations have been defined,
the current implementation infers the IG and parametrization given in \pref{fig:runningBRN}.
It can also successfully handle large PH models of BRNs found in the literature
