...
\begin{example*}
In the PH of \pref{fig:runningPH}, we infer a negative influence switch of $a$ on $b$ between levels $a_1$ and $a_2$, but not between $a_0$ and $a_1$, because:
\begin{align*}
...
\end{align*}
In the end, the IG inference from the PH of \pref{fig:runningPH} gives
